	...
	<view>
		<uni-forms>
			...
			<uni-forms-item>
				...
				<uni-easyinput v-model="regForm.name" placeholder="Input your preferredName"
					style="margin-top: 25rpx;" />
			</uni-forms-item>
			<uni-forms-item>
			...
			<uni-forms-item>
				<button @click="onReset" type="primary" :disabled="disable()">Reset</button>
			</uni-forms-item>
			<uni-forms-item>
				<text>Provide the information that you used to register</text>
			</uni-forms-item>
...
<script setup>
	...
	const onReset = () => {
		uni.showLoading({})
		request.userReset(regForm.value.username,
